...
export const CATEGORIES = [
	new Category('c1', 'Εικόνες - Αγιογραφίες', '#FFFACD'), // lemonchiffon
	new Category('c2', 'Εργόχειρα', '#AFEEEE'), // paleturquoise
	new Category('c3', 'Μοναστηριακά προϊόντα', '#ADD8E6'), // lightskyblue
